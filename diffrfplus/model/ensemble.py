"""
Main module for the DiFF-RF algorithm.
"""
#!/usr/bin/env python3
# -*- coding: utf-8 -*-
...
class DiFF_RF_Plus:
    ...
    def create_trees(self, data, feature_distribution: np.ndarray, sample_size: int, height_limit: float, hyperparams: dict) -> Node:
        """
